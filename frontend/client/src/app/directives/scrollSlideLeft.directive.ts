...
@Directive({
  selector: '[appScrollSlideLeft]',
  standalone: true,
})
export class ScrollSlideLeftDirective implements AfterViewInit {
  @Input() showClass: string = 'showToRight'; // A class to show the element
  @Input() hideClass: string = 'hideToLeft'; // A class to hide the element
